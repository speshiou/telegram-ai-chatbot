...
DEFAULT_MODEL = os.getenv('DEFAULT_MODEL', list(DEFAULT_MODELS.keys())[0])
ENABLE_SELECT_MODEL = os.getenv('ENABLE_SELECT_MODEL', True)
ENABLE_SELECT_MODEL = True if not ENABLE_SELECT_MODEL or ENABLE_SELECT_MODEL == True else False
ENABLE_CUSTOM_ROLE = os.getenv('ENABLE_CUSTOM_ROLE', True)
ENABLE_CUSTOM_ROLE = True if not ENABLE_CUSTOM_ROLE or ENABLE_CUSTOM_ROLE == True else False
